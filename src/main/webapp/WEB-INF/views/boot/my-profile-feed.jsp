...
<body>
	...
	<div class="wrapper">
		...
		<section class="cover-sec">
			<img src="${contextPath}/resources/bootstrap/images/resources/cover-img.jpg" alt="">
								...
								<div class="main-left-sidebar">
									<div class="user_profile">
										<div class="user-pro-img">
											<img src="${contextPath}/resources/bootstrap/images/resources/user-pro-img.png" alt="">
									...
									<div class="suggestions full-width">
										...
										<div class="suggestions-list">
											<div class="suggestion-usd">
												<img src="${contextPath}/resources/bootstrap/images/resources/s1.png" alt="">
												<div class="sgt-text">
											...
											<div class="suggestion-usd">
												<img src="${contextPath}/resources/bootstrap/images/resources/s2.png" alt="">
												<div class="sgt-text">
													<h4>John Doe</h4>
											...
											<div class="suggestion-usd">
												<img src="${contextPath}/resources/bootstrap/images/resources/s3.png" alt="">
												<div class="sgt-text">
													<h4>Poonam</h4>
											...
											<div class="suggestion-usd">
												<img src="${contextPath}/resources/bootstrap/images/resources/s4.png" alt="">
												<div class="sgt-text">
													<h4>Bill Gates</h4>
											...
											<div class="suggestion-usd">
												<img src="${contextPath}/resources/bootstrap/images/resources/s5.png" alt="">
												<div class="sgt-text">
													<h4>Jessica William</h4>
													<span>Graphic Designer</span>
												</div>
											...
											<div class="suggestion-usd">
												<img src="${contextPath}/resources/bootstrap/images/resources/s6.png" alt="">
												<div class="sgt-text">
													<h4>John Doe</h4>
													<span>PHP Developer</span>
												</div>
								...
								<div class="main-ws-sec">
										...
										<div class="star-descp">
											...
											<ul>
												<li data-tab="feed-dd" class="active">
													<a href="#" title="">
														<img src="${contextPath}/resources/bootstrap/images/ic1.png" alt="">
														<span>Feed</span>
													</a>
												</li>
												<li data-tab="info-dd">
													<a href="#" title="">
														<img src="${contextPath}/resources/bootstrap/images/ic2.png" alt="">
														<span>Info</span>
													</a>
												</li>
												<li data-tab="saved-jobs">
													<a href="#" title="">
														<img src="${contextPath}/resources/bootstrap/images/ic4.png" alt="">
														<span>Jobs</span>
													</a>
												</li>
												<li data-tab="my-bids">
													<a href="#" title="">
														<img src="${contextPath}/resources/bootstrap/images/ic5.png" alt="">
														<span>Bids</span>
													</a>
												</li>
												<li data-tab="portfolio-dd">
													<a href="#" title="">
														<img src="${contextPath}/resources/bootstrap/images/ic3.png" alt="">
														<span>Portfolio</span>
													</a>
												</li>
												<li data-tab="rewivewdata">
													<a href="#" title="">
														<img src="${contextPath}/resources/bootstrap/images/review.png" alt="">
														<span>Reviews</span>
													</a>
												</li>
												<li data-tab="payment-dd">
													<a href="#" title="">
														<img src="${contextPath}/resources/bootstrap/images/ic6.png" alt="">
														<span>Payment</span>
													</a>
												</li>
									...
									<div class="product-feed-tab current" id="feed-dd">
										<div class="posts-section">
											...
											<div class="post-bar">
												...
												<div class="epi-sec">
													<ul class="descp">
														<li><img src="${contextPath}/resources/bootstrap/images/icon8.png" alt=""><span>Front End Developer</span></li>
														<li><img src="${contextPath}/resources/bootstrap/images/icon9.png" alt=""><span>India</span></li>
													</ul>
													<ul class="bk-links">
														<li><a href="#" title=""><i class="la la-bookmark"></i></a></li>
                                          ...
                                          <div class="post-bar">
                                           ...
                                           <div class="tab-pane fade" id="bidders" role="tabpanel" aria-labelledby="bidders-tab">
											...
											<div class="post-bar">
												<div class="post_topbar post-bid">
													<div class="usy-dt">
														<img src="${contextPath}/resources/bootstrap/images/resources/jassica.jpg" alt="">
														<div class="usy-name">
														<h3>John Doe</h3>
														<div class="epi-sec epi2">
													     <ul class="descp descptab bklink">
											...
											<div class="post-bar">
												<div class="post_topbar post-bid">
													<div class="usy-dt">
														<img src="${contextPath}/resources/bootstrap/images/resources/rock.jpg" alt="">
														<div class="usy-name">
														<h3>John Doe</h3>
														<div class="epi-sec epi2">
													     <ul class="descp descptab bklink">
									...
									<div class="product-feed-tab" id="my-bids">
										<div class="posts-section">
											<div class="post-bar">
												...
												<div class="epi-sec">
													<ul class="descp">
														<li><img src="${contextPath}/resources/bootstrap/images/icon8.png" alt=""><span>Frontend Developer</span></li>
														<li><img src="${contextPath}/resources/bootstrap/images/icon9.png" alt=""><span>India</span></li>
													</ul>
													<ul class="bk-links">
														<li><a href="#" title=""><i class="la la-bookmark"></i></a></li>
												...
												<div class="job-status-bar">
													<ul class="like-com">
														...
														<li><a href="#" title="" class="com"><img src="${contextPath}/resources/bootstrap/images/com.png" alt=""> Comment 15</a></li>
													</ul>
											...
											<div class="process-comm">
												<a href="#" title=""><img src="${contextPath}/resources/bootstrap/images/process-icon.png" alt=""></a>
											</div><!--process-comm end-->
										</div><!--posts-section end-->
									</div><!--product-feed-tab end-->
												...
												<div class="row">
													<div class="col-lg-4 col-md-4 col-sm-6 col-6">
														<div class="gallery_pt">
															<img src="${contextPath}/resources/bootstrap/images/resources/pf-img1.jpg" alt="">
															<a href="#" title=""><img src="${contextPath}/resources/bootstrap/images/all-out.png" alt=""></a>
														</div><!--gallery_pt end-->
													</div>
													<div class="col-lg-4 col-md-4 col-sm-6 col-6">
														<div class="gallery_pt">
															<img src="${contextPath}/resources/bootstrap/images/resources/pf-img2.jpg" alt="">
															<a href="#" title=""><img src="${contextPath}/resources/bootstrap/images/all-out.png" alt=""></a>
														</div><!--gallery_pt end-->
													</div>
													<div class="col-lg-4 col-md-4 col-sm-6 col-6">
														<div class="gallery_pt">
															<img src="${contextPath}/resources/bootstrap/images/resources/pf-img3.jpg" alt="">
															<a href="#" title=""><img src="${contextPath}/resources/bootstrap/images/all-out.png" alt=""></a>
														</div><!--gallery_pt end-->
													</div>
													<div class="col-lg-4 col-md-4 col-sm-6 col-6">
														<div class="gallery_pt">
															<img src="${contextPath}/resources/bootstrap/images/resources/pf-img4.jpg" alt="">
															<a href="#" title=""><img src="${contextPath}/resources/bootstrap/images/all-out.png" alt=""></a>
														</div><!--gallery_pt end-->
													</div>
													<div class="col-lg-4 col-md-4 col-sm-6 col-6">
														<div class="gallery_pt">
															<img src="${contextPath}/resources/bootstrap/images/resources/pf-img5.jpg" alt="">
															<a href="#" title=""><img src="${contextPath}/resources/bootstrap/images/all-out.png" alt=""></a>
														</div><!--gallery_pt end-->
													</div>
													<div class="col-lg-4 col-md-4 col-sm-6 col-6">
														<div class="gallery_pt">
															<img src="${contextPath}/resources/bootstrap/images/resources/pf-img6.jpg" alt="">
															<a href="#" title=""><img src="${contextPath}/resources/bootstrap/images/all-out.png" alt=""></a>
														</div><!--gallery_pt end-->
													</div>
													<div class="col-lg-4 col-md-4 col-sm-6 col-6">
														<div class="gallery_pt">
															<img src="${contextPath}/resources/bootstrap/images/resources/pf-img7.jpg" alt="">
															<a href="#" title=""><img src="${contextPath}/resources/bootstrap/images/all-out.png" alt=""></a>
														</div><!--gallery_pt end-->
													</div>
													<div class="col-lg-4 col-md-4 col-sm-6 col-6">
														<div class="gallery_pt">
															<img src="${contextPath}/resources/bootstrap/images/resources/pf-img8.jpg" alt="">
															<a href="#" title=""><img src="${contextPath}/resources/bootstrap/images/all-out.png" alt=""></a>
														</div><!--gallery_pt end-->
													</div>
													<div class="col-lg-4 col-md-4 col-sm-6 col-6">
														<div class="gallery_pt">
															<img src="${contextPath}/resources/bootstrap/images/resources/pf-img9.jpg" alt="">
															<a href="#" title=""><img src="${contextPath}/resources/bootstrap/images/all-out.png" alt=""></a>
														</div><!--gallery_pt end-->
													</div>
													<div class="col-lg-4 col-md-4 col-sm-6 col-6">
														<div class="gallery_pt">
															<img src="${contextPath}/resources/bootstrap/images/resources/pf-img10.jpg" alt="">
															<a href="#" title=""><img src="${contextPath}/resources/bootstrap/images/all-out.png" alt=""></a>
														</div><!--gallery_pt end-->
													</div>
												</div>
									...
									<div class="product-feed-tab" id="payment-dd">
										<div class="billing-method">
											...
											<div class="lt-sec">
												<img src="${contextPath}/resources/bootstrap/images/lt-icon.png" alt="">
										...
										<div class="add-billing-method">
											<h3>Add Billing Method</h3>
											<h4><img src="${contextPath}/resources/bootstrap/images/dlr-icon.png" alt=""><span>With workwise payment protection , only pay for work delivered.</span></h4>
													...
													<div class="row">
														<div class="col-lg-12">
															<div class="cc-head">
																<h5>Card Number</h5>
																<ul>
																	<li><img src="${contextPath}/resources/bootstrap/images/cc-icon1.png" alt=""></li>
																	<li><img src="${contextPath}/resources/bootstrap/images/cc-icon2.png" alt=""></li>
																	<li><img src="${contextPath}/resources/bootstrap/images/cc-icon3.png" alt=""></li>
																	<li><img src="${contextPath}/resources/bootstrap/images/cc-icon4.png" alt=""></li>
																</ul>
															</div>
							...
							<div class="col-lg-3">
								<div class="right-sidebar">
									...
									<div class="widget widget-portfolio">
										<div class="wd-heady">
											<h3>Portfolio</h3>
											<img src="${contextPath}/resources/bootstrap/images/photo-icon.png" alt="">
										</div>
										<div class="pf-gallery">
											<ul>
												<li><a href="#" title=""><img src="${contextPath}/resources/bootstrap/images/resources/pf-gallery1.png" alt=""></a></li>
												<li><a href="#" title=""><img src="${contextPath}/resources/bootstrap/images/resources/pf-gallery2.png" alt=""></a></li>
												<li><a href="#" title=""><img src="${contextPath}/resources/bootstrap/images/resources/pf-gallery3.png" alt=""></a></li>
												<li><a href="#" title=""><img src="${contextPath}/resources/bootstrap/images/resources/pf-gallery4.png" alt=""></a></li>
												<li><a href="#" title=""><img src="${contextPath}/resources/bootstrap/images/resources/pf-gallery5.png" alt=""></a></li>
												<li><a href="#" title=""><img src="${contextPath}/resources/bootstrap/images/resources/pf-gallery6.png" alt=""></a></li>
												<li><a href="#" title=""><img src="${contextPath}/resources/bootstrap/images/resources/pf-gallery7.png" alt=""></a></li>
												<li><a href="#" title=""><img src="${contextPath}/resources/bootstrap/images/resources/pf-gallery8.png" alt=""></a></li>
												<li><a href="#" title=""><img src="${contextPath}/resources/bootstrap/images/resources/pf-gallery9.png" alt=""></a></li>
												<li><a href="#" title=""><img src="${contextPath}/resources/bootstrap/images/resources/pf-gallery10.png" alt=""></a></li>
												<li><a href="#" title=""><img src="${contextPath}/resources/bootstrap/images/resources/pf-gallery11.png" alt=""></a></li>
												<li><a href="#" title=""><img src="${contextPath}/resources/bootstrap/images/resources/pf-gallery12.png" alt=""></a></li>
											</ul>
										</div><!--pf-gallery end-->
		...
		<div class="overview-box" id="create-portfolio">
			<div class="overview-edit">
				...
				<form>
					...
					<div class="pf-img">
						<img src="${contextPath}/resources/bootstrap/images/resources/np.png" alt="">
					</div>
