                    ...
                    <div class="main-section-data">
                                ...
                                <div class="right-sidebar">
                                    ...
                                    <div class="widget widget-jobs">
                                        ...
                                        <div class="sd-title copylink">
                                            <ul>
                                            	<li>
                                                <img src="${contextPath}/resources/bootstrap/images/social3.png" alt="image"></li>
                                                <li>
                                                <img src="${contextPath}/resources/bootstrap/images/social5.png" alt="image"></li>
                                                <li>
                                                <img src="${contextPath}/resources/bootstrap/images/social1.png" alt="image"></li>
                                                <li>
                                                <img src="${contextPath}/resources/bootstrap/images/social4.png" alt="image"></li>
                                                <li>
                                                <img src="${contextPath}/resources/bootstrap/images/social2.png" alt="image">
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                        ...
                        <div class="freelancerbiding">
                            ...
                            <div class="row">
                                <div class="col-md-4 col-sm-12">
                                    <div class="usy-dt">
                                        <img src="${contextPath}/resources/bootstrap/images/resources/jass.png" alt="">
                                        <div class="usy-name">
                                            <h3>Jass Singh</h3>
                                            <span><img src="${contextPath}/resources/bootstrap/images/icon9.png" alt="">India</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4 col-sm-12">
                                ...
                                <div class="col-md-4 col-sm-12">
                                    <div class="usy-dt">
                                        ...
                                        <div class="usy-name">
                                            ...
                                            <span><img src="${contextPath}/resources/bootstrap/images/icon9.png" alt="">New York</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4 col-sm-12">
                            ...
                            <div class="row">
                                <div class="col-md-4 col-sm-12">
                                    <div class="usy-dt">
                                        <img src="${contextPath}/resources/bootstrap/images/resources/smith.png" alt="">
                                        <div class="usy-name">
                                            <h3>Rock Smith</h3>
                                            <span><img src="${contextPath}/resources/bootstrap/images/icon9.png" alt="">Australia</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4 col-sm-12">
