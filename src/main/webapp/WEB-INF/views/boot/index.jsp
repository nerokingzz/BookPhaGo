							...
							<div class="col-lg-3 col-md-4 pd-left-none no-pd">
								<div class="main-left-sidebar no-margin">
									<div class="user-data full-width">
										<div class="user-profile">
											<div class="username-dt">
												<div class="usr-pic">
													<img src="${contextPath}/resources/bootstrap/images/resources/user-pic.png" alt="">
												</div>
											</div><!--username-dt end-->
									...
									<div class="tags-sec full-width">
										...
										<div class="cp-sec">
											<img src="${contextPath}/resources/bootstrap/images/logo2.png" alt="">
											<p><img src="${contextPath}/resources/bootstrap/images/cp.png" alt="">Copyright 2019</p>
										</div>
									</div><!--tags-sec end-->
