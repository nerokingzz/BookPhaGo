								...
								<div class="helpforum">
			                     <div class="row">
								  ...
								  <div class="actions">
								  	...
								  	<h3><img src="${contextPath}/resources/bootstrap/images/resources/icon1.png" alt="image"> Popular Actions</h3>
								  		<hr>
								  	</div>
								  ...
								  <div class="actions">
								  	<div class="actionstitle">
								  	<h3><img src="${contextPath}/resources/bootstrap/images/resources/icon2.png" alt="image"> Suggested for you</h3>
								  		<hr>
								  	</div>
								  		<div class="actionstext">
								  	<div class="row">
								  ...
								  <!-- endactione -->
								  <div class="helpform">
								  			<img src="${contextPath}/resources/bootstrap/images/resources/formicon.png" alt="image">
								  			<h3>Help Forum</h3>
