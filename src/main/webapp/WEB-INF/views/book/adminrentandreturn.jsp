...
<input type="hidden" name="page" value="rent_A">
		...
		<div class="col-md-12 col-sm-12"><br>
			 <h6>도서번호 : <input type="text" name="bookNumber1" id="bookNumber1" class="bookNumber1"> <input type="button" value="검색" onclick="searchbNumber(test);"></h6><br>
		</div>
		<div class="col-md-12 col-sm-12"><br>
		...
		<div class="col-md-12 col-sm-12"><br>
		<button type="submit" onclick="return check()" disabled>신청하기</button>		
		</div>	                                
</form>			                               
